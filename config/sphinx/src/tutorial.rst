...
The tutorial is also available as a Docker container.
This simplifies getting and installing FleCSI and its dependencies.
In general, FleCSI docker images are available from the
`flecsi organization on dockerhub.com`__.

__ https://hub.docker.com/repository/docker/flecsi/flecsi
...
.. code-block:: console
  ...
  $ docker pull flecsi/flecsi:tutorial
...
.. code-block:: console
  ...
  $ docker run -it flecsi/flecsi:tutorial

This will place you into a bash prompt, from which you can build and run
the tutorial examples. The tutorials are in the *tutorial* directory in
*/home/flecsi*.
